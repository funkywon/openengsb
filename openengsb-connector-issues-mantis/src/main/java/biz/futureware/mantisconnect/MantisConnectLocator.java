...
public class MantisConnectLocator extends org.apache.axis.client.Service implements biz.futureware.mantisconnect.MantisConnect {
    ...
    private java.lang.String MantisConnectPort_address = "http://85.126.79.3/mantis/api/soap/mantisconnect.php";
    ...
    public biz.futureware.mantisconnect.MantisConnectPortType getMantisConnectPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            biz.futureware.mantisconnect.MantisConnectBindingStub _stub = new biz.futureware.mantisconnect.MantisConnectBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (biz.futureware.mantisconnect.MantisConnectPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                biz.futureware.mantisconnect.MantisConnectBindingStub _stub = new biz.futureware.mantisconnect.MantisConnectBindingStub(new java.net.URL(MantisConnectPort_address), this);
                _stub.setPortName(getMantisConnectPortWSDDServiceName());
                return _stub;
            }
        }
