...
public class CustomFieldDefinitionData  implements java.io.Serializable {
    ...
    public CustomFieldDefinitionData(
           biz.futureware.mantisconnect.ObjectRef field,
     ...
     * @return field
     */
    public biz.futureware.mantisconnect.ObjectRef getField() {
        return field;
    }
     ...
     * @param field
     */
    public void setField(biz.futureware.mantisconnect.ObjectRef field) {
        this.field = field;
    }
