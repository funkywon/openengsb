...
public class FilterData  implements java.io.Serializable {
    ...
    private biz.futureware.mantisconnect.AccountData owner;
    ...
    public FilterData(
           ...
           biz.futureware.mantisconnect.AccountData owner,
     ...
     * @return owner
     */
    public biz.futureware.mantisconnect.AccountData getOwner() {
        return owner;
    }
     ...
     * @param owner
     */
    public void setOwner(biz.futureware.mantisconnect.AccountData owner) {
        this.owner = owner;
    }
