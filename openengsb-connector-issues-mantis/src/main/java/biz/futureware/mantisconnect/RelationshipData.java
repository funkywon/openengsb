...
public class RelationshipData  implements java.io.Serializable {
    ...
    private biz.futureware.mantisconnect.ObjectRef type;
    ...
    public RelationshipData(
           ...
           biz.futureware.mantisconnect.ObjectRef type,
     ...
     * @return type
     */
    public biz.futureware.mantisconnect.ObjectRef getType() {
        return type;
    }
     ...
     * @param type
     */
    public void setType(biz.futureware.mantisconnect.ObjectRef type) {
        this.type = type;
    }
