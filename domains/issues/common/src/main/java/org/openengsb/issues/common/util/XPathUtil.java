...
public class XPathUtil {
	...
	public static Node extractSingleNode(NormalizedMessage inMessage,
		...
		if (rootNode == null) {
			...
			return XPathUtil.XPATH.selectSingleNode(rootNode, xPath);
		}
	}
	...
	public static NodeList extractNodeList(NormalizedMessage inMessage,
		...
		if (rootNode == null) {
			...
			return XPathUtil.XPATH.selectNodeList(rootNode, xPath);
		}
	}
	...
	public static String extractStringParameter(Node inNode, String xpath)
			throws TransformerException {
		// get parameter
		Node node = XPathUtil.XPATH.selectSingleNode(inNode, xpath);
